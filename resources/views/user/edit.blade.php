      ...
      <form class="col s12" action="{{ route('user.update', $user->id) }}" method="POST">
        ...
        <div class="row">
          <div class="col s12">
            <p>
              <label>
                <input id='tipo_id_aluno' name="tipo_id" type="radio"
                       value="1" {{ $user->tipo_id == 1 ? 'checked' : '' }} />
                <span>Aluno</span>
              </label>
              <label>
                <input id='tipo_id_adm' name="tipo_id" type="radio"
                       value="2" {{ $user->tipo_id == 2 ? 'checked' : '' }} />
