          ...
          @switch($alternativa->letra)
            ...
            <div class="row">
              <div class="input-field col s12 m8">
                <input placeholder="Alternativa" id="alternativa_a" value="{{ $alternativa->alternativa }}" type="text"
                       name="alternativa_a">
            ...
            <div class="row">
              <div class="input-field col s12 m8">
                <input placeholder="Alternativa" id="alternativa_b" value="{{ $alternativa->alternativa }}" type="text"
                       name="alternativa_b">
            ...
            <div class="row">
              <div class="input-field col s12 m8">
                <input placeholder="Alternativa" id="alternativa_c" value="{{ $alternativa->alternativa }}" type="text"
                       name="alternativa_c">
            ...
            <div class="row">
              <div class="input-field col s12 m8">
                <input placeholder="Alternativa" id="alternativa_d" value="{{ $alternativa->alternativa }}" type="text"
                       name="alternativa_d">
