  ...
  <div class="section">
    ...
    @if ($erro == 1)
      <div class="row">
        <div class="col s12 m6">
          <script>
             M.toast({html: 'Há outro email cadastrado semelhante ao seu. Digite um novo email!', outDuration: 8000});
          </script>
        </div>
      </div>
      <br>
    @elseif ($erro == 2)
      <div class="row">
        <div class="col s12 m6">
          <script>
             M.toast({html: 'Há outro RG cadastrado semelhante ao seu!'}, outDuration
             :
             8000
             })
             ;
    ...
    @elseif ($erro == 3)
      <div class="row">
        <div class="col s12 m6">
          <script>
             M.toast({html: 'Há outro CPF cadastrado semelhante ao seu!'}, outDuration
             :
             8000
             })
             ;
      ...
      <form class="col s12" action="{{ route('aluno.store') }}" method="POST">
        ...
        <div class="row">
          ...
          <div class="input-field col s12 m6 l2">
            <input id="rg" class="rg" placeholder="Numero do seu RG" type="text" name="rg" data-mask=""
        ...
        <div class="row">
          ...
          <div class="input-field col s12 m6 l2">
            <input id="dataNascimento" class="date" type="text" name="dataNascimento" placeholder="DD/MM/AAAA"
                   pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}" title="O formato deve ser DD/MM/AAAA." required>
        ...
        <div class="row">
          <div class="input-field col s12 m6 l4">
            <select id="renda" name="renda" required>
              ...
              <option value="2">Até dois salários mínimos</option>
              <option value="3">Até três salários mínimos</option>
        ...
        <div class="row">
          ...
          <div class="col s12 m6 l5">
            <p>
              ...
              <label>
                <input id='outro' name="sexo" type="radio" required
                       onclick="document.getElementById('outros').disabled = !this.checked;"/>
                <span>Outro</span>
              </label>
            </p>
          </div>
          ...
          <div class="input-field col s12 m6 l4">
            <input id="outros" type="text" name="sexo" disabled>
            <label for="nome">Digite seu Gênero</label>
          </div>
