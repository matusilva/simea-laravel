     ...
     $(function () {
        ...
        var graficoSexo = Highcharts.chart('graficoSexo', {
           ...
           series: [{
              ...
              innerSize: '50%',
              colorByPoint: true,
              data: [{name: 'Feminino', y: <?=$porcentagemMulheres?> }, {
                 name: 'Masculino',
                 y: <?=$porcentagemHomens?> }]
           }]
        });
        ...
        var graficoEtnia = Highcharts.chart('graficoEtnia', {
           ...
           series: [{
              ...
              innerSize: '50%',
              colorByPoint: true,
              data: [{name: 'Branco', y: <?=$porcentagemBrancos?> }, {
                 name: 'Pardo',
                 y: <?=$porcentagemPardo?> }, {name: 'Preto', y: <?=$porcentagemPreto?> }, {
                 name: 'Indigena',
                 y: <?=$porcentagemIndigena?> }, {name: 'Quilombola', y: <?=$porcentagemQuilombola?> }]
           }]
        });
        ...
        var graficoRenda = Highcharts.chart('graficoRenda', {
           ...
           series: [{
              name: 'Alunos',
              colorByPoint: true,
              data: [{name: 'Quatro salários ou mais', y: <?=$porcentagemQuatroSalarios?> }, {
                 name: 'Três salários',
                 y: <?=$porcentagemTresSalarios?> }, {
                 name: 'Dois salários',
                 y: <?=$porcentagemDoisSalarios?> }, {name: 'Um salário', y: <?=$porcentagemUmSalario?> }]
           }]
        });
        ...
        var graficoEstadoCivil = Highcharts.chart('graficoEstadoCivil', {
           ...
           series: [{
              name: 'Alunos',
              colorByPoint: true,
              data: [{name: 'Viúvo', y: <?=$porcentagemViuvos?> }, {
                 name: 'Divorciado',
                 y: <?=$porcentagemDivorciados?> }, {name: 'Casado', y: <?=$porcentagemCasados?> }, {
                 name: 'Solteiro',
                 y: <?=$porcentagemSolteiros?> }]
           }]
        });
